    ...
    return (
      <div>
        <h4 className="font-weight-bold py-3 mb-4">
          <span className="text-muted font-weight-light">Icons /</span> Ionicons
        </h4>
        ...
        <div className="text-center">
          {this.state.icons.map(icon => (
            <Card
              ...
              className="icon-example icon-example-ion d-inline-flex justify-content-center align-items-center my-2 mx-2">
              <i className={`d-block ion ion-${icon}`}></i>
            </Card>
          ))}
        </div>

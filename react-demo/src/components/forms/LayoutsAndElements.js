...
class LayoutsAndElements extends Component {
  constructor(props) {
    super(props)
    props.setTitle('Layouts and elements - Forms')
  }
    ...
    return (
      <div>
        <h4 className="font-weight-bold py-3 mb-4">
          <span className="text-muted font-weight-light">Forms /</span> Layouts and elements
        </h4>

        <Card className="mb-4">
          <Card.Header as="h6">Default</Card.Header>            
          <Card.Body>
            <Form>
              <Form.Group>
        ...
        <Card className="mb-4">
          <Card.Header as="h6">Form row</Card.Header>
          <Card.Body>
            <Form>
              <Form.Row>
        ...
        <Card className="mb-4">
          <Card.Header as="h6">Horizontal</Card.Header>
          <Card.Body>
            <Form>
              <Form.Group as={Row}>
        ...
        <Card className="mb-4">
          <Card.Header as="h6">Inline</Card.Header>
          <Card.Body>
        ...
        <Card className="mb-4">
          <Card.Header as="h6">Help text</Card.Header>
          <Card.Body>
            <Form className="mb-4">
              <Form.Group>
                <Form.Label>Password</Form.Label>
        ...
        <Card className="mb-4">
          <Card.Header as="h6">Static controls</Card.Header>
          <Card.Body>
            <Form className="mb-4">
              <Form.Group as={Row}>
                <Form.Label column sm={2} className="text-sm-right">Email</Form.Label>
        ...
        <Card className="mb-4">
          <Card.Header as="h6">States</Card.Header>
          <Card.Body>
            {/* Valid */}
            <Form.Group>
...
export default LayoutsAndElements

...
class Layout2FlexExample extends Component {
  constructor(props) {
    super(props)
    props.setTitle('Layout 2 (Flex) - Layouts')
  }
      ...
      <div className="d-flex align-items-stretch flex-grow-1">
        ...
        <div className="flex-grow-1 container-p-x container-p-y">
          <h4 className="font-weight-bold py-3 mb-4">
            <span className="text-muted font-weight-light">Layouts /</span> Layout 2 (Flex)
          </h4>
...
export default Layout2FlexExample

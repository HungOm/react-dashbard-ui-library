...
import { Media, Button, Badge, Form, OverlayTrigger, Tooltip, ListGroup } from 'react-bootstrap'
...
class MessagesV1List extends Component {
  constructor(props) {
    super(props)
    props.setTitle('Messages list v1 - Pages')
      ...
      <div className={`messages-wrapper ${this.state.sideboxOpen ? 'messages-sidebox-open' : ''}`}>
        ...
        <div className="d-flex flex-column w-100">
          ...
          <div className="flex-grow-0">
            ...
            <Media as="h4" className="align-items-center font-weight-bold container-p-x py-3 py-lg-4 m-0">
              <a href="#toggle-sidebox" onClick={this.toggleSidebox} className="messages-sidebox-toggler d-lg-none d-block align-self-center text-muted px-3 mr-3"><i className="ion ion-md-more"></i></a>
              <Media.Body>
                <i className="ion ion-ios-filing"></i> &nbsp; Inbox
              </Media.Body>
            ...
            <PerfectScrollbar options={{ suppressScrollX: true, wheelPropagation: true }} className="messages-content messages-scroll">
              <ListGroup className="messages-list">
                ...
                {this.state.messagesData.map(message =>
                  <ListGroup.Item className="container-p-x" key={message.id}>

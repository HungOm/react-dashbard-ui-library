...
import { Media, Button, Badge, Form, OverlayTrigger, Tooltip, Card, Row, Col } from 'react-bootstrap'
...
class MessagesV2Item extends Component {
  constructor(props) {
    super(props)
    props.setTitle('Message item v2 - Pages')
        ...
        <Card className={`messages-card ${this.state.sideboxOpen ? 'messages-sidebox-open' : ''}`}>
          <Row noGutters>
            ...
            <Col>
              ...
              {/* Header */}
              <Media className="p-4">
                <a onClick={this.toggleSidebox} href="#toggle-sidebox" className="messages-sidebox-toggler d-lg-none d-block align-self-center text-muted text-large pr-3 mr-3"><i className="ion ion-md-more"></i></a>
              ...
              {/* Controls */}
              <Media className="flex-wrap align-items-center p-2">

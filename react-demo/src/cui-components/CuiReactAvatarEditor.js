...
class CuiReactAvatarEditor extends Component {
  constructor(props) {
    super(props)
  ...
  render() {
    return (
      <div className="ui-block">
        <h3 className="ui-block-heading">react-avatar-editor</h3>
        <a target="_blank" rel="noopener noreferrer" href="https://github.com/mosch/react-avatar-editor" className="ui-block-description">https://github.com/mosch/react-avatar-editor</a>
...
export default CuiReactAvatarEditor

...
class CuiReactBigCalendar extends Component {
  constructor(props) {
    super(props)
  ...
  render() {
    ...
    return (
      <div className="ui-block">
        <h3 className="ui-block-heading">react-big-calendar</h3>
        <a target="_blank" rel="noopener noreferrer" href="https://github.com/intljusticemission/react-big-calendar" className="ui-block-description">https://github.com/intljusticemission/react-big-calendar</a>

        <h4 className="ui-block-heading">Examples</h4>

        <div className="alert alert-warning rtl-only mt-5">
          <strong>react-big-calendar</strong> does not support Drad&Drop in RTL mode.
        </div>
...
export default CuiReactBigCalendar
